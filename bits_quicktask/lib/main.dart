...
void main() async {
  ...
  final keyApplicationId = '1MoWPLzYnYJVnCzbIisKDRDqpxVQoOaE4eDSV8XF';
  final keyClientKey = 'fzL5tK5EiTrmsxsgXxqTqaugWKwrGJpZVbQK2i1G';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        style:
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromARGB(176, 162, 247, 97))
       ),
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Quick Task - Edit', style:
              TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Color.fromARGB(246, 148, 230, 246))),
        backgroundColor: Color.fromARGB(255, 42, 42, 42),
        centerTitle: true
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromARGB(246, 148, 230, 246))),
            ),
          ],
        ),
      ),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: Color.fromARGB(246, 148, 230, 246), // Background color
              ),
              onPressed: () async {
